...
<div align="center">
  <table cellpadding="2" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
    <tr align="center">
      <th height=25 class="topbg"><strong><%=SiteName%>----服务器信息</strong></th>
    </tr>
    <tr>
      <td height=23 class="tdbg"><div align="right">特别感谢<a href="http://www.ajiang.net">【阿江守候】</a>提供此探针程序！</div>
...
<br>■ IIS自带的ASP组件
<table width=100% border="0" cellpadding="0" cellspacing="1" class="tableBorder" style="border-collapse: collapse">
	<tr height=22 align=center><th width=470>组 件 名 称</th><th width=300>支持及版本</th></tr>
	<%For i=0 to 10%>
	<tr height="18" class="forumRow">
		<td align=left>&nbsp;<%=ObjTotest(i,0) & "<font color=#009286>&nbsp;" & ObjTotest(i,1)%></font></td>
		<td align=left>&nbsp;<%
		If Not ObjTotest(i,2) Then 
			Response.Write "<font color=red><b>×</b></font>"
		Else
			Response.Write "<font color=green><b>√</b></font> <a title='" & ObjTotest(i,3) & "'>" & left(ObjTotest(i,3),11) & "</a>"
		End If%></td>
	</tr>
	<%next%>
</table>
...
<br>■ 常见的文件上传和管理组件
<table width=100% border="0" cellpadding="3" cellspacing="1" class="tableBorder" style="border-collapse: collapse">
	<tr height=22 align=center><th width=473>组 件 名 称</th><th width=300>支持及版本</th></tr>
	<%For i=11 to 15%>
	<tr height="18" class="forumRow">
		<td align=left>&nbsp;<%=ObjTotest(i,0) & "<font color=#009286>&nbsp;" & ObjTotest(i,1)%></font></td>
		<td align=left>&nbsp;<%
...
<table width=100% border="0" cellpadding="0" cellspacing="0" class="tableBorder" style="border-collapse: collapse">
<FORM action="?" method=post id=form1 name=form1>
	<tr height="18" class="forumRow">
		
      <td height=30 align="center">&nbsp; 
        <input class=input type=text name="classname" value="" size=40>
<INPUT type=submit value=" 确 定 " id=submit1 name=submit1>
<INPUT type=reset value=" 重 填 " id=reset1 name=reset1> 
</td>
    </tr>
</FORM>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" class="tableBorder" width=100%>
  <tr height=18 class=backs align=center>
	<th width=458>服&nbsp;&nbsp;&nbsp;务&nbsp;&nbsp;&nbsp;器</th><th width=300>完成时间</th></tr>
  <tr class="forumRow" height=18>
