...
Sub DiskView()
	...
	Call EA_M_XML.AppInfo("hPic_2",drawbar("../db"))
	Call EA_M_XML.AppInfo("hPic_3",drawbar("../userfiles"))
	Call EA_M_XML.AppInfo("hPic_4",drawbar("./"))
	Call EA_M_XML.AppInfo("hPic_5",drawbar("../list"))
	Call EA_M_XML.AppInfo("hPic_6",drawbar("../view"))

	Call EA_M_XML.AppElements("InfoBackup",showSpaceinfo("databackup"))
	Call EA_M_XML.AppElements("InfoDepot",showSpaceinfo("../db"))
	Call EA_M_XML.AppElements("InfoUserFiles",showSpaceinfo("../userfiles"))
	Call EA_M_XML.AppElements("InfoThis",showSpaceinfo("./"))
	Call EA_M_XML.AppElements("InfoHTMLList",showSpaceinfo("../list"))
	Call EA_M_XML.AppElements("InfoHTMLView",showSpaceinfo("../view"))
