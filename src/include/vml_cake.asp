<%
function Cake_Table(total,table_x,table_y,all_width,all_height,table_type)
...
Dim tb_height,total_no,totalpie,PreAngle,pie,temppie,TempAngle,x1,y1,x2,y2,x3,y3,x4,y4,x5,y5
tb_height=30
